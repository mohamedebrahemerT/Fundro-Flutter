...
class WalletInterestDetailsScreen extends StatelessWidget {
  const WalletInterestDetailsScreen({super.key});
  ...
  Widget _buildHeaderCard() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text(
            "هل أحصل علي أي فائدة علي رصيد محفظتي بالدرهم الإماراتي ؟",
  ...
  Widget _buildContentCard() {
    return Container(
      ...
      child: const Text(
        "لا، لن تكسب لن أي فائدة إضافية على رصيد محفظتك السيولة التي تحتفظ بها في محفظتك لا تدر أي فائدة وستظل كما هي دون تحقيق أي أرباح إضافية عليها",
        textAlign: TextAlign.right,
        style: TextStyle(
          fontSize: 13,
